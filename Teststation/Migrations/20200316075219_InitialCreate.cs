        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CircuitType = table.Column<byte>(nullable: true),
                    InitialCurrent = table.Column<double>(nullable: true),
                    Amperage = table.Column<double>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    NeededResistance = table.Column<double>(nullable: false),
                    Position = table.Column<int>(nullable: false),
                    QuestionId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CircuitParts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CircuitParts_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    CorrectResistance = table.Column<double>(nullable: false),
                    Visible = table.Column<bool>(nullable: false),
                    CircuitPartId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Resistors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Resistors_CircuitParts_CircuitPartId",
                        column: x => x.CircuitPartId,
                        principalTable: "CircuitParts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CandidateId = table.Column<long>(nullable: false),
                    Discriminator = table.Column<string>(nullable: false),
                    GivenResistance = table.Column<double>(nullable: true),
                    ResistorId = table.Column<long>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Answers_Resistors_ResistorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CircuitParts_QuestionId",
                table: "CircuitParts",
                column: "QuestionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resistors_CircuitPartId",
                table: "Resistors",
                column: "CircuitPartId");
